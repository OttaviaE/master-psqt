...
\usepackage{multicol}
\usepackage{multirow}
\setbeamersize{text margin left=8pt, text margin right=9pt}
...
\date[PSQT, 2025]{Master di II Livello \\ Psicologia quantitativa: Misurazione, valutazione e analisi di variabili psicosociali }
\institute[]{11 Settembre 2026, Padova}
\author[Ottavia M. Epifania]{\texorpdfstring{Ottavia M. Epifania, Ph.D.\newline\url{ottavia.epifania@unitn.it}}{Author}}
...
\begin{frame}
	\Large
	\centering
	Volete misurare il pregiudizio: Come fate? 
	
\normalsize
\href{https://app.wooclap.com/IPRHENI?from=status-bar}{Rispondete su wooclap.com} usando il codice: IPRHENI

(se il link non funziona): wooclap.com e inserite il codice)

	
\end{frame}

\section[Cognizione]{Cognizione e Cognizione sociale}
...
\begin{tikzpicture}[
	...
	\node[box, below=of cognition] (social) {
		\textbf{Social Cognition}\\[-1mm]
		\scriptsize
		Processes by which people come to understand others
		\textit{(Schacter, Gilbert, \& Wegner, 2009)}
	};
	
	\node[boxhi, below=of social] (implicit) {
		\textbf{Implicit Social Cognition}\\[-1mm]
		\scriptsize
		Cognitive processes occurring outside conscious awareness or conscious
		control in relation to social psychological constructs such as attitudes,
		stereotypes, and self-concepts
		\textit{(Greenwald \& Banaji, 1995)}
	};
	
	\draw[arrow] (cognition.south) -- (social.north);
	\draw[arrow] (social.south) -- (implicit.north);
	
\end{tikzpicture}
\end{frame}

\subsection*{Categorizzare}
...
\begin{frame}
	...
	\begin{block}{Cognizione}
				...
				\begin{figure}
					\centering
					\includegraphics[width=0.2\linewidth]{categorize}
				\end{figure}
			...
			\begin{block}{Cognizione sociale}
				...
				\begin{figure}
					\centering
					\includegraphics[width=0.2\linewidth]{categorize1}
				\end{figure}
...
\section[Validità]{Validità delle misure in Psicologia}
...
\section[Mis. esplicita]{Misurazione esplicita}
...
\begin{frame}
	...
	\begin{exampleblock}{}
		...
		\begin{itemize}
			...
			\item Con quale frequenza ti sei sentito allegro nelle ultime due settimane? 
...
\subsection*{Visual Analougue Scale}
\begin{frame}{}
...
\begin{frame}{Un problema della persona o della misura?}
	
	\begin{center}
		\large
		
		Vogliamo misurare un \textbf{atteggiamento socialmente sensibile}.
		
		\vspace{5mm}
		
		Una persona fornisce una risposta\\
		\textbf{socialmente desiderabile}.
		...
		\textbf{come potremmo costruire una misura che renda più difficile\\
			controllare volontariamente la risposta?}
		
	\end{center}
	
\end{frame}

\section[Mis. implicita]{Misurazione implicita: Davvero la soluzione?}
...
\subsection*{Associazioni Automatiche}
\begin{frame}
	\begin{center}
...
\begin{frame}
	...
	\begin{quote}
		Essere rapidi nell'associare i serpenti ad aggettivi o parole con valenza negativa non implica che non si sia consapevoli dei propri atteggiamenti negativi verso i serpenti!
	\end{quote}
...
\begin{frame}
	wooclap.com, codice IPRHENI
\end{frame}

\subsection*{Uno dei problemi}
\begin{frame}
	\onslide<1->
...
\section[Validity]{A measure in search of a construct}
